		...
		<table>
			...
			while(rs.next()){
				...
				<tr>
					...
					<td><%=rs.getString(4).equals("Y")?"Y":"~"%></td>
					<td><%=rs.getString(5).equals("Y")?"Y":"~"%></td>
					<td><%=rs.getString(6).equals("Y")?"Y":"~"%></td>
					<td><%=rs.getString(7).equals("Y")?"Y":"~"%></td>
					<td><%=rs.getString(8).equals("Y")?"Y":"~"%></td>
					<td><%=rs.getString(9).equals("Y")?"Y":"~"%></td>
